...
<?php setPostViews(get_the_ID()); ?>
	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<!-- article -->
		<article id="post-<?php the_ID(); ?>" <?php post_class('wrapper-estandar-post'); ?>>
			...
			<div class="content">
				...
				<small class="meta-bottom-post">
					 <?php echo getPostViews(get_the_ID()); ?>
					/ <?php comments_number('No hay comentarios','1 Comentarios', '% Comentarios'); ?>
				</small>
			</div>
